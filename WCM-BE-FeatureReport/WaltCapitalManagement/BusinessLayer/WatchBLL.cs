        ...
        public CommonResponse UpdatePrivileges(UpdatePrivilegesReqDTO updatePrivilegesReqDTO)
        {
            ...
            try
            {
                if (updatePrivilegesReqDTO != null && updatePrivilegesReqDTO.Privileges != null)
                {
                    ...
                    if (accessCategoryList != null && accessCategoryList.Count > 0)
                    {
                        var accessCategoryPermissionList = _commonRepo.accessCategoryPermissionMsts().Where(x => x.GroupId == updatePrivilegesReqDTO.GroupId).ToList();
                        foreach (var accessCategoryPermission in accessCategoryPermissionList)
                        {
                ...
                if (addPrivilegeReqDTO != null && addPrivilegeReqDTO.GroupId != 0)
                {
                    ...
                    if (accessCategory != null)
                    {
                        ...
                        else
                        {
                            ...
                            // var ds = _commonRepo.accessCategoryPermissionMsts().Where(ac => ac.Id == res.Id).FirstOrDefault();
                            ...
                            //accessCategoryPermissionMst = new AccessCategoryPermissionMst();
                            //accessCategoryPermissionMst.GroupId = addPrivilegeReqDTO.GroupId;
                            //accessCategoryPermissionMst.AccessableCategoryId = addPrivilegeReqDTO.AccessCategoryId;
                            //accessCategoryPermissionMst.IsActive = true;
                            //accessCategoryPermissionMst.IsDeleted = false;
                            //accessCategoryPermissionMst.CreatedBy = addPrivilegeReqDTO.UpdatedBy;
                            //accessCategoryPermissionMst.UpdatedBy = addPrivilegeReqDTO.UpdatedBy;
                            //accessCategoryPermissionMst.CreatedDate = _commonHelper.GetCurrentDateTime();
                            //accessCategoryPermissionMst.UpdatedDate = _commonHelper.GetCurrentDateTime();
...
//foreach (var item in accessCategoryMstList)
//{
//    var checkPermissionId = _commonRepo.accessCategoryPermissionMsts().Where(x => x.AccessableCategoryId == item.Id).FirstOrDefault();
//    if (checkPermissionId == null)
//    {
//        accessCategoryPermissionMst = new AccessCategoryPermissionMst();
//        accessCategoryPermissionMst.GroupId = addPrivilegeReqDTO.GroupId;
//        accessCategoryPermissionMst.AccessableCategoryId = item.Id;
//        accessCategoryPermissionMst.IsActive = true;
//        accessCategoryPermissionMst.IsDeleted = false;
//        accessCategoryPermissionMst.CreatedBy = addPrivilegeReqDTO.UpdatedBy;
//        accessCategoryPermissionMst.UpdatedBy = addPrivilegeReqDTO.UpdatedBy;
...
//        _dbContext.SaveChanges();
//    }
//    var c = _commonRepo.accessCategoryList().Where(x => x.ParentId == item.Id).ToList();
//    if (c != null)
//    {
//        foreach (var item3 in c)
//        {
//            var b = _commonRepo.accessCategoryPermissionMsts().Where(x => x.AccessableCategoryId == item3.Id).FirstOrDefault();
//            if (b == null)
//            {
//                accessCategoryPermissionMst = new AccessCategoryPermissionMst();
//                accessCategoryPermissionMst.GroupId = addPrivilegeReqDTO.GroupId;
//                accessCategoryPermissionMst.AccessableCategoryId = item3.Id;
//                accessCategoryPermissionMst.IsActive = true;
//                accessCategoryPermissionMst.IsDeleted = false;
//                accessCategoryPermissionMst.CreatedBy = addPrivilegeReqDTO.UpdatedBy;
//                accessCategoryPermissionMst.UpdatedBy = addPrivilegeReqDTO.UpdatedBy;
...
//var accessCategorydetails = _commonRepo.accessCategoryList().Where(x => x.Id == addPrivilegeReqDTO.AccessCategoryId).FirstOrDefault();
//var accessCategoryPermissionDetails = _commonRepo.accessCategoryPermissionMsts().Where(x => x.AccessableCategoryId == accessCategorydetails.ParentId).FirstOrDefault();
//if (accessCategoryPermissionDetails == null && accessCategorydetails.ParentId != 0)
//{
//    var checkPermissionId = _commonRepo.accessCategoryPermissionMsts().Where(x => x.AccessableCategoryId == accessCategorydetails.ParentId).FirstOrDefault();
//    if (checkPermissionId == null)
//    {
//        accessCategoryPermissionMst = new AccessCategoryPermissionMst();
//        accessCategoryPermissionMst.GroupId = addPrivilegeReqDTO.GroupId;
//        accessCategoryPermissionMst.AccessableCategoryId = accessCategorydetails.ParentId;
//        accessCategoryPermissionMst.IsActive = true;
//        accessCategoryPermissionMst.IsDeleted = false;
//        accessCategoryPermissionMst.CreatedBy = addPrivilegeReqDTO.UpdatedBy;
//        accessCategoryPermissionMst.UpdatedBy = addPrivilegeReqDTO.UpdatedBy;
