        ...
        public CommonResponse GetPPMClientList(GetPPMClientListReqDTO getPPMClientListReqDTO)
        {
            ...
            try
            {
                ...
                foreach (var row in res)
                {
                   ...
                   pPMClientDetail.AccountNo = row.ClientAccountNo;
                   pPMClientDetail.AccValue = row.AccountValue;
                ...
                {
                    pPMClientDetailList = pPMClientDetailList.Where(x => x.Name.ToLower().StartsWith(getPPMClientListReqDTO.Alphabet.ToLower())).ToList();
                ...
                {
                    pPMClientDetailList = pPMClientDetailList.Where(x => Convert.ToString(x.AccValue).Contains(getPPMClientListReqDTO.SearchString.ToLower()) || x.Name.ToLower().Contains(getPPMClientListReqDTO.SearchString.ToLower()) || Convert.ToString(x.AccValue).Contains(getPPMClientListReqDTO.SearchString.ToLower())).ToList();
                ...
                if (orderby)
                {
                    ...
                    {
                        pPMClientDetailList = pPMClientDetailList.OrderBy(x => x.Surname).ToList();
                    }
                    else
                    {
                        pPMClientDetailList = pPMClientDetailList.Skip((number - 1) * size).Take(size).OrderBy(x => x.Surname).ToList();
                    }
                }
                else
                {
                    if (pPMClientDetailList.Count <= size)
                    {
                        pPMClientDetailList = pPMClientDetailList.OrderByDescending(x => x.Surname).ToList();
                    }
                    else
                    {
                        pPMClientDetailList = pPMClientDetailList.OrderByDescending(x => x.Surname).Skip((number - 1) * size).Take(size).ToList();
                    }
                }
        ...
        public CommonResponse GetPPMClientListTFSA(GetPPMClientListTFSAReqDTO getPPMClientListTFSAReqDTO)
        {
            ...
            try
            {
                ...
                foreach (var row in res)
                {
                    ...
                    pPMClientTFSADetail.AccountNo = row.ClientAccountNo;
                    pPMClientTFSADetail.AccValue = row.AccountValue;
                ...
                {
                    pPMClientTFSA = pPMClientTFSA.Where(x => x.Name.ToLower().StartsWith(getPPMClientListTFSAReqDTO.Alphabet.ToLower())).ToList();
                ...
                {
                    pPMClientTFSA = pPMClientTFSA.Where(x => Convert.ToString(x.AccValue).Contains(getPPMClientListTFSAReqDTO.SearchString.ToLower()) || x.Name.ToLower().Contains(getPPMClientListTFSAReqDTO.SearchString.ToLower()) || Convert.ToString(x.AccValue).Contains(getPPMClientListTFSAReqDTO.SearchString.ToLower())).ToList();
                ...
                if (orderby)
                {
                    ...
                    {
                        pPMClientTFSA = pPMClientTFSA.OrderBy(x => x.Surname).ToList();
                    }
                    else
                    {
                ...
                else
                {
                    if (pPMClientTFSA.Count <= size)
                    {
                        pPMClientTFSA = pPMClientTFSA.OrderByDescending(x => x.Surname).ToList();
                    }
                    else
                    {
                        pPMClientTFSA = pPMClientTFSA.OrderByDescending(x => x.Surname).Skip((number - 1) * size)
                            .Take(size)
                            .ToList();
                    }
                }
