    ...
    public class IFABLL
    {
        ...
        public CommonResponse GetAllIFAList(GetIFAAssetReqDTO getIFAAssetReqDTO)
        {
            ...
            try
            {
                ...
                iFAList = _commonRepo.ALLUserList().Where(x => x.AccessCategoryId == 3).Select(x => new IFAAsseList
                {
                    Id = x.Id,
                    Name = x.FirstName,
                    SurName = x.LastName,
        ...
        public CommonResponse GenerateIFAAccountNo()
        {
            ...
            try
            {
                ...
                int totalIFAs = _commonRepo.ALLUserList().Where(x => x.AccessCategoryId == 3).Count();
