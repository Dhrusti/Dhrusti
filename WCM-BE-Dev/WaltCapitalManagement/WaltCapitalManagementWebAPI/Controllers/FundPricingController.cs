...
namespace WaltCapitalManagementWebAPI.Controllers
{
    ...
    public class FundPricingController : ControllerBase
    {
        ...
        [HttpPost("GetEditPricingDetail")]
        public CommonResponse GetEditPricingDetail(GetEditPricingDetailReqViewModel getEditPricingDetailReqViewModel)
        {
            CommonResponse commonResponse = new CommonResponse();
            try
            {
                commonResponse = _ifundPricing.GetEditPricingDetail(getEditPricingDetailReqViewModel.Adapt<GetEditPricingDetailReqDTO>());

                GetEditPricingDetailResDTO getEditPricingDetailResDTO=commonResponse.Data ?? new GetEditPricingDetailResDTO();
                commonResponse.Data = getEditPricingDetailResDTO.Adapt<GetEditPricingDetailResViewModel>();
        ...
        public CommonResponse UpdatePricing(UpdatePricingReqViewModel updatePricingReqViewModel)
        {
            CommonResponse commonResponse = new CommonResponse();
            try
            {
                commonResponse = _ifundPricing.UpdatePricing(updatePricingReqViewModel.Adapt<UpdatePricingReqDTO>());
