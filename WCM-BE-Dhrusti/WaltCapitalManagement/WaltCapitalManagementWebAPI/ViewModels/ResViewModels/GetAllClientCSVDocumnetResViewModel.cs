...
{
    public class GetAllClientCSVDocumnetResViewModel
    {
        public int TotalCount { get; set; }
        public List<ClientCSVDocumentDetails> ClientCSVDocumentList { get; set; }
    }

    public class ClientCSVDocumentDetails
    {
