...
namespace WaltCapitalManagementWebAPI.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost("GetClientAllDetailById")]
        public CommonResponse GetClientAllDetailById(GetClientAllDetailByIdReqViewModel getClientAllDetailByIdReqViewModel)
        {
            CommonResponse commonResponse = new CommonResponse();
            try
            {
                commonResponse = _iUser.GetClientAllDetailById(getClientAllDetailByIdReqViewModel.Adapt<GetClientAllDetailByIdReqDTO>());
                GetClientAllDetailByIdResDTO ClientResDTO = commonResponse.Data ?? new GetClientAllDetailByIdResDTO();
                commonResponse.Data = ClientResDTO.Adapt<GetClientAllDetailByIdResViewModel>();
            }
            catch (Exception) { throw; }
            return commonResponse;
        }
