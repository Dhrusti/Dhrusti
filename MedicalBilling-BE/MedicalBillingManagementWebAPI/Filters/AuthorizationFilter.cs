...
namespace MedicalBillingManagementWebAPI.Filters
{
    public class AuthorizationFilter : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public AuthorizationFilter(IConfiguration configuration, MedicalBillingDbContext dbContext, CommonHelper commonHelper, AuthRepo authRepo)
        {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            try
            {
                ...
                if (isAllEncrypted)
                {
                    ...
                    if (!string.IsNullOrEmpty(data) && data != "GetDecryption" && data != "GetEncryption" && data != "AddIdProof" && data != "AddAddressProof" && data != "AddProfilePhoto" && data != "UploadCSVDocument" && data != "UploadClientCSVDocument")
